...
import NetworkPanel from "@/public/assets/Images/home/networkpanel.png"
...
const networkNodes = [
  ...
  { label: "Certus", left: "38%", top: "50%", size: "23.5%", active: true },
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-0 my-16 lg:my-24">
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-[1.37fr_1fr_1fr] gap-4">
        {/* Main Card — Certus */}
        <div className="relative overflow-hidden rounded-3xl border border-white bg-linear-to-br from-white/92 to-white/62 shadow-[0_0_29px_0_rgba(52,67,122,0.09)] p-7">
          ...
          <div className="relative bottom-4 -left-4 flex size-22 items-center justify-center">
            <Image src={CertusCardIcon} alt="Certus" className="size-22" />
          </div>
          ...
          <div className="relative mt-6 mb-10 grid grid-cols-3 gap-4 border-t border-[#E5E8ED] pt-5">
            <div>
              <p className="font-bold text-foreground text-sm">6 sec</p>
          ...
          <div className="relative flex-1 min-h-[220px] overflow-hidden rounded-3xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
              <div className="relative size-72">
                ...
                <Image src={GlassPanelIcon} alt="" className="absolute inset-0 m-auto size-46" />
              </div>
              <p className="-mt-20 mb-10 text-xs text-white/85">Posts only what it can verify.</p>
            </div>
          </div>
        </div>
        ...
        <div>
          <div>
            <Image
              src={NetworkPanel}
              alt=""
              className="w-full -mx-7 -mt-6 -mb-3"
            />
          </div>
          <div className="rounded-3xl border border-white bg-gradient-to-br from-white/92 to-white/62 shadow-[0_0_29px_0_rgba(52,67,122,0.09)] px-6 py-5 text-center max-w-xs">
