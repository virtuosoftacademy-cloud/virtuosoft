...
export default function ProcessingByHand() {
  return (
    <section className="bg-white py-16 md:py-24">
      <div className={SHELL}>
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <p className="text-[10px] font-medium uppercase tracking-[1.2px] text-[#808799]">
              Per document
            </p>
            ...
            <div className="mt-4 flex flex-col items-stretch gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex-1 rounded-[22px] border border-white/95 bg-gradient-to-br from-white/95 to-white/60 p-5 shadow-[0px_0px_29px_0px_rgba(52,67,122,0.09)] ring-1 ring-[#eef1f8]">
                ...
                <p className="mt-4 text-[30px] font-bold tracking-[-0.45px] text-[#13161b]">
                  60 Min
                </p>
                <p className="text-[12px] leading-4 text-[#808799]">
                  per document, today
                </p>
                <ul className="mt-4 flex flex-col gap-[7px]">
                  {manualPoints.map((point) => (
                    <li key={point} className="flex items-center gap-2">
                      ...
                      <span className="text-[12px] leading-4 text-[#4a5261]">
                        {point}
                      </span>
                    </li>
                  ))}
              ...
              <div className="flex shrink-0 flex-row items-center justify-center gap-3 px-4 sm:flex-col sm:gap-2">
                <span className="relative inline-flex h-7 w-[61px] items-center justify-center overflow-hidden rounded-full">
                  ...
                  />
                  <span className="relative text-[12px] font-medium tracking-[0.24px] text-white">
                    ~600×
                  </span>
                </span>
                <span className="text-[26px] font-bold text-[#808799]">→</span>
                <span className="text-[9px] font-medium uppercase tracking-[0.36px] text-[#808799]">
                  faster
                </span>
              </div>
              ...
              <div className="relative flex-1 overflow-hidden rounded-[24px] p-5">
                ...
                <div className="relative">
                  ...
                  <p className="mt-4 text-[30px] font-bold tracking-[-0.45px] text-white">
                    6 Sec
                  </p>
                  <p className="text-[12px] leading-4 text-[#d9e0f5]">
