...
import { ErpEmpower, ErpHero, HelixEmpower ,HelixHero,DynamicsHero,DynamicsEmpower,ManageEngineHero,EngineEmpower,stepsDataErp,stepsDataHelix ,stepsDataDynamics,stepsDataEngine,valueDataErp ,valueDataHelix,valueDataDynamics, valueDataEngine, IbmHero, IbmvalueData, IbmstepsData, IbmEmpower, type ValueSectionData, type TimeLineData, type EmpowerData } from '../constant';
import { Faq_ERP ,Faq_Helix,Faq_Dynamics ,Faq_ManageEngine, Faq_Ibm } from '@/app/_constant';

// The section list is intentionally heterogeneous: each entry pairs a
// component with the exact prop shape that component expects. `ElementType`
// is React's own type for "any renderable component/tag", used here because
// the list mixes components with entirely different prop signatures.
...
interface Service {
  ...
  // Not populated by any entry below; kept optional so the pre-existing
  // `service.hero?.bottomDescription` lookup in generateMetadata still type-checks.
  hero?: { bottomDescription?: string };
}
