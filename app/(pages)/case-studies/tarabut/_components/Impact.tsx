...
function Impact() {
  return (
    <section className="mx-auto max-w-7xl px-6 pb-16 md:px-10 lg:pb-24">
      ...
      <h2 className="font-helvetica-now-display mt-5 max-w-[766px] text-4xl leading-[1.2] text-[#050f21] md:text-[40px]">
        ...
        {caseStudies_Impact.map((row, index) => (
          ...
          >
            <div className="flex w-full shrink-0 items-center gap-3.5 lg:w-[219px]">
              ...
              <span className="font-helvetica-now-display text-[17px] font-extrabold tracking-[-0.05px] text-[#13161b]">
                {row.label}
              </span>
            </div>

            <div className="flex flex-1 flex-col items-stretch gap-3 lg:flex-row lg:items-center lg:gap-4">
              <p className="font-helvetica-now-display flex items-center rounded-full bg-[#fcecea] px-4 py-2.5 text-sm font-extrabold leading-[1.4] text-[#d03836] lg:w-[449px] lg:shrink-0">
                {row.before}
              </p>
              <Image
                src={Arrow}
              ...
              />
              <p className="font-helvetica-now-display flex flex-1 items-center rounded-full bg-[#e6f6ee] px-4 py-2.5 text-sm font-extrabold leading-[1.4] text-[#059669]">
                {row.after}
              </p>
            </div>
          </div>
